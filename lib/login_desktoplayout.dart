                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                         children: [
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                Text("Precision Workforce Tracking",
                                style: TextStyle(fontSize: 30,
                                fontWeight: FontWeight.bold),
                                ),
                                SizedBox(height: 10,),
                                Text("Experience the future of attendance management with our cutting-edge isometric reporting and real-time kiosk integration.",
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text("Login to manage attendance records",
                            ...
                            TextField(
                              decoration: InputDecoration(
                                ...
                                hintStyle: TextStyle(color: Color.fromRGBO(64, 63, 63, 1),
                                fontSize: 14),
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          ...
                                          side: BorderSide(color: Color.fromRGBO(199, 195, 195, 1),
                                          width: 1.5)
                                          ),
                                          minimumSize: Size(double.infinity, 50)
                                          ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          child: Text("Sign Up",
                                          textAlign: TextAlign.center,
                                          style: TextStyle(color: Color.fromRGBO(48, 102, 208, 1)),),
                                        )
                                      ],
                                    )
                          ],
